...
set default as=65111 router-id=10.255.255.1

/routing bgp peer
add name=peerHKI remote-address=10.255.255.2 address-families=l2vpn,vpnv4 remote-as=65111 update-source=loopback route-reflect=no 
...
add bridge=vpn export-route-targets=65111:100 import-route-targets=65111:100 name=vpn route-distinguisher=65111:100 site-id=1
