...
set default as=65111 router-id=10.255.255.2

/routing bgp peer
add name=peerSPB address-families=l2vpn,vpnv4 remote-address=10.255.255.1 remote-as=65111 update-source=loopback route-reflect=no
add name=peerLND address-families=l2vpn,vpnv4 remote-address=10.255.255.4 remote-as=65111 update-source=loopback route-reflect=yes
add name=peerLBN address-families=l2vpn,vpnv4 remote-address=10.255.255.5 remote-as=65111 update-source=loopback route-reflect=yes
