...
set default as=65111 router-id=10.255.255.5

/routing bgp peer
add name=peerSVL remote-address=10.255.255.3 address-families=l2vpn,vpnv4 remote-as=65111 update-source=loopback route-reflect=no
...
add name=peerLND remote-address=10.255.255.4 address-families=l2vpn,vpnv4 remote-as=65111 update-source=loopback route-reflect=yes
